...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* خلفية توهج */}
      <div
        className="fixed top-0 left-1/2 w-[600px] h-[600px] rounded-full opacity-5 pointer-events-none"
      ...
      <div className="max-w-5xl mx-auto px-4 py-16 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-slate-700 text-lg leading-relaxed max-w-3xl mx-auto mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-16">
          {[
            ...
            <div 
              key={i} 
              className="flex items-start gap-4 p-5 rounded-2xl transition hover:scale-[1.02] bg-white border border-slate-200 shadow-sm"
            >
              <div className="w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0 gradient-bg">
                <CheckCircle size={20} className="text-white" />
              </div>
              <p className="text-slate-700 text-sm leading-relaxed pt-2 font-bold">{point}</p>
            </div>
          ))}
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
          ...
          {/* رؤيتنا */}
          <div 
            className="rounded-3xl p-8 relative overflow-hidden group bg-white border border-slate-200 shadow-sm"
          >
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-2xl font-black text-slate-800">رؤيتنا</h2>
            </div>
          ...
          >
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-2xl font-black text-slate-800">رسالتنا</h2>
            </div>
            <p className="text-slate-600 leading-relaxed">
        ...
        <div 
          className="rounded-3xl p-8 md:p-10 text-center bg-white border border-slate-200 shadow-sm"
        >
          ...
          <h2 className="text-3xl font-black text-slate-800 mb-8">لماذا يختارنا العملاء؟</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-4">
            {[
              ...
              <div key={i} className="flex flex-col items-center gap-2 p-4">
                ...
                <p className="text-slate-700 font-bold text-sm">{feature}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="text-center mt-16">
          <div className="inline-flex items-center gap-3 px-8 py-4 rounded-2xl bg-purple-50 border border-purple-200">
